...
cache_hierarchy = MESITwoLevelCacheHierarchy(
        ...
        # mediumlow_retention_data_read_latency=4,
        # mediumlow_retention_tag_read_latency=4,
        # mediumlow_retention_data_write_latency=4,
        # mediumlow_retention_tag_write_latency=4,
        #
        # mediumhigh_retention_data_read_latency=6,
        # mediumhigh_retention_tag_read_latency=6,
        # mediumhigh_retention_data_write_latency=6,
        # mediumhigh_retention_tag_write_latency=6,
